...
<p>Been There, Done That ("BTDT", "us", "we", or "our") operates the BTDT mobile application (the "Service").</p>

<p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. Our Privacy Policy  for BTDT is created with the help of the <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator.php">Free Privacy Policy Generator</a>.</p>
...
<p>BTDT operates on the basis of storing and showcasing countries and other places the user has been (as declared by the user) among some statistics (referred to as Achievements). This data is declared, added and removed by the user and is stored again on a Firebase Real-Time Database.</p>

<b>Refer to here for the GDPR-compliancy of Firebase services: https://firebase.google.com/support/privacy</b>
...
<p>BTDT uses the collected data for various purposes:</p>    
<ul>
...
<p>BTDT will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

<h2>Disclosure Of Data</h2>

<h3>Legal Requirements</h3>
<p>BTDT may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
<ul>
    <li>To comply with a legal obligation</li>
    <li>To protect and defend the rights or property of BTDT</li>
